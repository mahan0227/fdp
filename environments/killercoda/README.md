...
**App:** web portal at `/` · JSON at `/api` · probes at `/healthz`. Videos walk the full guide, including opening the portal in the browser.
...
| `videos/lab1-build-and-ship.mp4` | Demo: build, portal, isolate, push |
| `videos/lab2-kubernetes-hosting.mp4` | Demo: deploy, portal, load-balance, heal, scale |
...
- Curl: `localhost:$PORT/api`. Portal: `http://localhost:$PORT`.
